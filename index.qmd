...
## Recent example what can happen if we trust LLMs with everything

![Jeremy Crane reported his PocketOS start-up's experience [here](https://x.com/lifeof_jer/status/2048103471019434248), read more [here](https://www.theguardian.com/technology/2026/apr/29/claude-ai-deletes-firm-database)](ai-deleted-everything.png)
